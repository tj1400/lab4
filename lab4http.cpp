...
char *get_ip(char *host)
{
    ...
    // *
    //Fixed error: can't resolove host with inet_ntop: no space left on device
    //if (inet_ntop(AF_INET, (void *) hent->h_addr_list[0], ip, iplen) ==  NULL)
    //This fixes it because ip length is 15 chars + an ending, but iplen is only 15 and doesn't allow for the ending.
